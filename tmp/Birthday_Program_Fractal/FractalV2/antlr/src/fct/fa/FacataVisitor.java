...
public interface FacataVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code AssignNItersStatement_}
	 * labeled alternative in {@link FacataParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignNItersStatement_(FacataParser.AssignNItersStatement_Context ctx);
	/**
	 * Visit a parse tree produced by the {@code AssignGammaStatement_}
	 * labeled alternative in {@link FacataParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignGammaStatement_(FacataParser.AssignGammaStatement_Context ctx);
	/**
