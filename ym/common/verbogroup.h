...
struct VerboGroupMask
{
   ...
   #define YM_MAKE_MSK_AND_UNIT_MSK(Name_)            Name_ = YM_FMT_MSK(           Name_), \
      ...
      YM_MAKE_MSK_AND_UNIT_MSK(ColorScheme),
      YM_MAKE_MSK_AND_UNIT_MSK(FastMath   ),
      YM_MAKE_MSK_AND_UNIT_MSK(Fitter     ),
      Flame       = YM_FMT_MSK(Flame      ),
      YM_MAKE_MSK_AND_UNIT_MSK(Pixel      ),
      YM_MAKE_MSK_AND_UNIT_MSK(Point      ),
      YM_MAKE_MSK_AND_UNIT_MSK(Render     ),
      YM_MAKE_MSK_AND_UNIT_MSK(Strangor   ),
